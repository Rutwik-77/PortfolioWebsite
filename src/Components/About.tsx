...
//   return (
//     <div
//       className='bg-red-300 relative overflow-hidden font-mono h-[80vh] px-20'
//       id='bg'
//     >
//       <Particles
...
//         <h3 className='text-3xl mb-2 text-greencolor'>Hii,I am</h3>
//         <h1 className='md:text-6xl text-5xl font-extrabold mb-3 '>
//           {Info.name}
//         </h1>
...
//           </span>
//         </div>
//         <p className='my-4 text-sm leading-6'>{Info.Bio}</p>
//         <Button
//           onClick={open}
